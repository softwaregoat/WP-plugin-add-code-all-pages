            ...
            foreach ($optionMetaData as $aOptionKey => $aOptionMeta) {
                if (isset($_POST[$aOptionKey])) {
                    ...
                    $args = array(
                        ...
                        'email' => $_POST[$aOptionKey]
                    );
                    $response = wp_remote_post('https://www.vcx3.com/de/register_woocommerce', array('body'=>$args));
//                    $response = wp_remote_post('http://localhost/test_post.php', array('body'=>$args));
...
//                    print_r($args);
        ...
        <div class="wrap">
            ...
            <h2><?php echo $this->getPluginDisplayName(); echo ' '; _e('Settings', 'vcx3'); ?></h2>
            ...
            <?php settings_fields($settingsGroup); ?>
                        ...
                        ?>
                            <tr valign="top">
                                ...
                                <?php $this->createFormControl($aOptionKey, $aOptionMeta, $savedOptionValue); ?>
                                    <p style="color: red;">Plugin is <?php echo $savedOptionValue===''?'InActivate. Please input email and Activate Plugin':'Activate';  ?></p>
                                    <p>lorem ipsum...</p>
                                </td>
                            </tr>
                        <?php
                ...
                <p class="submit">
                    <input type="submit" class="button-primary"
                           value="<?php _e('Activate Plugin', 'vcx3') ?>"/>
                </p>
            </form>
        </div>
        <?php
    ...
    protected function createFormControl($aOptionKey, $aOptionMeta, $savedOptionValue) {
        if (is_array($aOptionMeta) && count($aOptionMeta) >= 2) { // Drop-down list
            ...
            ?>
             <p><input type="email" name="<?php echo $aOptionKey ?>" id="<?php echo $aOptionKey ?>"
                      value="<?php echo esc_attr($savedOptionValue) ?>" size="50" required/></p>
            <?php
